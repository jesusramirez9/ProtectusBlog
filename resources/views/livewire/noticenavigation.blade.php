...
<header class="bg-gray-100" x-data="{open: false}">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start py-4">
                ...
                <div class="flex items-center text-black">
                    <a href="{{ route('posts.index') }}" class="text-black  hidden lg:block {{ request()->is('noticias') ? 'active linktran  bg-yellow-500 px-4 rounded-md underline' : '' }}">
                        Noticias
                    </a>
                </div>
            </div>
