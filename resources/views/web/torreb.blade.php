                        ...
                        <h1 class="mt-12 mb-8 px-6 text-center text-lg md:text-2xl font-semibold ">
                          ...
                          <div id="mainCarousel" class="carousel mb-4 w-10/12 max-w-xl mx-auto">
                            <div class="carousel__slide">
                              <img data-lazy-src="{{ asset('img/torre/torreb.jpeg') }}" />
                            </div>
                            <div class="carousel__slide">
                                ...
                                <ul class="flex flex-col">
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(1)">
                                        ...
                                        <div x-ref="tab" :style="handleToggle()"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                ...
                                                <a href="{{asset('recibo/torreb/piso1.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso1.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(2)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso2.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso2.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(3)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso3.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso3.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(4)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso4.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso4.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(5)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso5.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso5.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(6)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso6.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso6.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(7)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso7.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso7.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(8)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso8.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso8.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(9)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso9.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso9.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(10)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso10.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso10.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(11)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso11.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso11.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
                                    <li class="bg-white my-2 shadow-lg" x-data="accordion(12)">
                                        ...
                                        <div class="border-l-2 border-purple-600 overflow-hidden max-h-0 duration-500 transition-all"
                                            ...
                                            <div class="py-2 mx-2 flex items-center">
                                                <p>Descarga tu recibo aquí: </p>
                                                <a href="{{asset('recibo/torreb/piso12.pdf')}}" class="bg-red-500 ml-5 hover:bg-red-400 hover:px-2  cursor-pointer py-1 px-2 text-white font-semibold rounded-lg"  download="piso12.pdf"  target="_blank"><i class="fa-solid fa-download"></i> Recibo</a>     
                                            </div>
                                        </div>
                                    </li>
