        ...
        <main>
            <div class="container mt-14">
                ...
                <div class="text-center my-8">
                    <p class="text-gray-700 text-xl">Escoje la torre a la cual perteneces</p>
                </div>
        
                <div class="grid grid-cols-2 text-center md:flex md:justify-center">
                    <div class="my-6 md:my-2 md:mx-4">
                        <a href="{{ route('web.torrea') }}"
                            class="bg-gray-600 rounded-xl px-4 py-2 font-medium text-white hover:bg-gray-700 hover:border-2 hover:border-gray-800 hover:transition-all hover:ease-in-out cursor-pointer">Torre
                            A</a>
                    </div>
                    <div class="my-6 md:my-2 md:mx-4">
                        <a href="{{ route('web.torreb') }}"
                            class="bg-gray-600 rounded-xl px-4 py-2 font-medium text-white hover:bg-gray-700 hover:border-2 hover:border-gray-800 hover:transition-all hover:ease-in-out cursor-pointer">Torre
                            B</a>
                    </div>
                    <div class="my-6 md:my-2 md:mx-4">
                        <a href="{{ route('web.torrec') }}"
                            class="bg-gray-600 rounded-xl px-4 py-2 font-medium text-white hover:bg-gray-700 hover:border-2 hover:border-gray-800 hover:transition-all hover:ease-in-out cursor-pointer">Torre
                            C</a>
                    </div>
                    <div class="my-6 md:my-2 md:mx-4">
                        <a href="{{ route('web.torred') }}"
                            class="bg-gray-600 rounded-xl px-4 py-2 font-medium text-white hover:bg-gray-700 hover:border-2 hover:border-gray-800 hover:transition-all hover:ease-in-out cursor-pointer">Torre
                            D</a>
                    </div>
                </div>
